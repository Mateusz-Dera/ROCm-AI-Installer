...
|Name|Links|Additional information|
|:---|:---|:---|
|Fastfetch|https://github.com/fastfetch-cli/fastfetch|1. Custom Fastfetch configuration with GPU memory info.<br> 2. Script supports not only AMD but also NVIDIA graphics cards:<br> ```sudo apt-get install intel-gpu-tools```|
