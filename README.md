...
|Name|Links|Additional information|
|:---|:---|:---|
|Cinemo|https://huggingface.co/spaces/maxin-cn/Cinemo<br> https://github.com/maxin-cn/Cinemo|Interface uses PyTorch 2.4.0.|
...
|trellis-refactored|https://github.com/kg-git-dev/trellis-refactored<br> https://github.com/jwfromm/pytorch3d.git|Interface uses PyTorch 2.5.0.<br> Script uses PyTorch3d fork by jwfromm.|
...
|OpenRGB (Flatpak)|https://openrgb.org/|Kernel 6.15 is required.<br> Reboot after installation is recommended.|

## Additional steps:
> [!Caution]
> Kernel 6.15 supports I2C for AMD cards, so its installation is recommended for OpenRGB.
> Script is tested on this version of kernel.

1\. Install Mainline Kernels:
```bash
...
2\. Install kernel 6.15 and reboot.
