...
def decompose_polish_text(text: str) -> str:
    return "".join(POLISH_DECOMPOSE_MAP.get(char, char) for char in text)
...
def generate_tts_audio(
    ...
    # Apply Polish text decomposition if language is Polish
    if language_id == "pl":
        text_input = decompose_polish_text(text_input)
        print(f"Applied Polish text decomposition: '{text_input[:50]}...'")
...
demo.launch(mcp_server=False, share=False, server_name="0.0.0.0")