...
# ============================================================
# PHASE 18: ComfyUI workflow – Qwen-Image-2512-GGUF (text-to-image)
# ============================================================
phase18_comfyui_qwen_image_2512() {
    info "============================================="
    info "PHASE 18: ComfyUI – Qwen-Image-2512-GGUF"
    info "============================================="
...
main() { phase18_comfyui_qwen_image_2512; }
main "$@"
