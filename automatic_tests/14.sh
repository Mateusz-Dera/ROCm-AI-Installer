...
# ============================================================
# PHASE 14: RUN AND VERIFY – ACE-Step (text-to-music)
# ============================================================
phase14_verify_acestep() {
    info "============================================="
    info "PHASE 14: RUN AND VERIFY (ACE-Step)"
    info "============================================="
    ...
    # pkill -f 'acestep' kills bash itself — run in isolation.
    podman exec -t rocm bash -c "pkill -f 'acestep' 2>/dev/null; true" 2>/dev/null || true
    sleep 3
