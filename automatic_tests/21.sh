...
# ============================================================
# PHASE 21: ComfyUI workflow – Z-Image-Turbo (text-to-image)
# ============================================================
phase21_comfyui_z_image_turbo() {
    info "============================================="
    info "PHASE 21: ComfyUI – Z-Image-Turbo"
    info "============================================="
...
main() { phase21_comfyui_z_image_turbo; }
main "$@"
