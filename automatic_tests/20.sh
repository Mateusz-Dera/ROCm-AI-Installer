...
# ============================================================
# PHASE 20: ComfyUI workflow – Z-Image-Turbo (text-to-image)
# ============================================================
phase20_comfyui_z_image_turbo() {
    info "============================================="
    info "PHASE 20: ComfyUI – Z-Image-Turbo"
    info "============================================="
...
main() { phase20_comfyui_z_image_turbo; }
main "$@"
