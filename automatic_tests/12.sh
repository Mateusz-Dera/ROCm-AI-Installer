...
# ============================================================
# PHASE 12: ComfyUI workflow – Qwen-Image-2512-GGUF (text-to-image)
# ============================================================
phase12_comfyui_qwen_image_2512() {
    info "============================================="
    info "PHASE 12: ComfyUI – Qwen-Image-2512-GGUF"
    info "============================================="
...
main() { phase12_comfyui_qwen_image_2512; }
main "$@"
