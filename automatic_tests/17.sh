...
# ============================================================
# PHASE 17: RUN AND VERIFY – ACE-Step-1.5 (text-to-music)
# ============================================================
phase17_verify_ace_step_1_5() {
    info "============================================="
    info "PHASE 17: RUN AND VERIFY (ACE-Step-1.5)"
    info "============================================="
...
main() { phase17_verify_ace_step_1_5; }
main "$@"
