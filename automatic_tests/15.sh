...
# ============================================================
# PHASE 15: RUN AND VERIFY – ACE-Step-1.5 (text-to-music)
# ============================================================
phase15_verify_ace_step_1_5() {
    info "============================================="
    info "PHASE 15: RUN AND VERIFY (ACE-Step-1.5)"
    info "============================================="
...
main() { phase15_verify_ace_step_1_5; }
main "$@"
