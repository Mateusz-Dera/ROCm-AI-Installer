...
# ============================================================
# PHASE 16: RUN AND VERIFY – ACE-Step-1.5 (text-to-music)
# ============================================================
phase16_verify_ace_step_1_5() {
    info "============================================="
    info "PHASE 16: RUN AND VERIFY (ACE-Step-1.5)"
    info "============================================="
...
main() { phase16_verify_ace_step_1_5; }
main "$@"
